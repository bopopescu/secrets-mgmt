...
class nwusage(XDCRNewBaseTest):
    ...
    def test_nwusage_with_rebalance_in(self):
        ...
        self.verify_results()
        self._verify_bandwidth_usage(node=self.src_cluster.get_main_node(), nw_limit=nw_limit, no_of_nodes=3)
    ...
    def test_nwusage_with_rebalance_out(self):
        ...
        self.verify_results()
        self._verify_bandwidth_usage(node=self.src_cluster.get_main_node(), nw_limit=nw_limit, no_of_nodes=1)
    ...
    def test_nwusage_reset_to_zero(self):
        ...
        self.verify_results()
        self._verify_bandwidth_usage(node=self.src_cluster.get_main_node(), nw_limit=nw_limit, end_time=event_time)
        self._verify_bandwidth_usage(node=self.src_cluster.get_main_node(), nw_limit=0, no_of_nodes=2, event_time=event_time, nw_usage="0")
    ...
    def test_nwusage_with_hard_failover_and_bwthrottle_enabled(self):
        ...
        self._verify_bandwidth_usage(node=self.src_cluster.get_main_node(), event_time=failover_time, end_time=node_back_time, no_of_nodes=1)
    ...
    def test_nwusage_with_hard_failover_and_bwthrottle_enabled_later(self):
        ...
        self.verify_results()
        self._verify_bandwidth_usage(node=self.src_cluster.get_main_node(), event_time=bw_enable_time, end_time=node_back_time, no_of_nodes=1)
        self._verify_bandwidth_usage(node=self.src_cluster.get_main_node(), event_time=node_back_time)
    ...
    def test_nwusage_with_auto_failover_and_bwthrottle_enabled(self):
        ...
        self._verify_bandwidth_usage(node=self.src_cluster.get_main_node(), event_time=failover_time, end_time=node_back_time, no_of_nodes=2)
    ...
    def test_nwusage_with_auto_failover_and_bwthrottle_enabled_later(self):
        ...
        self.verify_results()
        self._verify_bandwidth_usage(node=self.src_cluster.get_main_node(), event_time=bw_enable_time, end_time=node_back_time, no_of_nodes=2)
        self._verify_bandwidth_usage(node=self.src_cluster.get_main_node(), event_time=node_back_time, no_of_nodes=3)